...
//-----------------------------------------------------------------------------
// Laser Crosshairs for VR weapons
//-----------------------------------------------------------------------------
...
CLaserCrosshair *CLaserCrosshair::Create( const Vector &origin, CBaseEntity *pOwner, bool bVisibleDot )
{
	...
	pLaserDot->SetContextThink( &CLaserCrosshair::LaserThink, gpGlobals->curtime + 0.1f, g_pLaserSightThink  );
...
Vector CLaserCrosshair::GetChasePosition()
{
